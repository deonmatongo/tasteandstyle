      ...
      <div className="recap-hero" style={{ backgroundImage: `url(${event.image})` }}>
        ...
        <div className="recap-hero-inner">
          <Link to="/events" className="recap-back-btn">
            <ArrowLeft size={16} strokeWidth={2} /> All Editions
          </Link>
          <div className="recap-hero-content reveal">
            <span className="section-label" style={{ color: 'var(--gold)' }}>Edition {event.edition} · Recap</span>
      ...
      <div className="recap-body">
        ...
        {event.highlights && event.highlights.length > 0 && (
          <div className="recap-highlights reveal reveal-delay-2">
            <h2 className="recap-highlights-heading">Evening Highlights</h2>
        ...
        {event.guests && event.guests.length > 0 && (
          <div className="recap-guests reveal reveal-delay-2">
            <h2 className="recap-highlights-heading">On the Night</h2>
        ...
        <div className="recap-cta reveal reveal-delay-3">
          <p className="recap-cta-text">Want to be part of the next edition?</p>
          <Link to="/events" className="btn-secondary">View Upcoming Editions →</Link>
        </div>
